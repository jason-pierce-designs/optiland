...
given back to the holders, based on the rarity of their Trainer(s). The
rarest type, "Dragonborn", consists of 3% of all Trainers and when it
comes to revenue gets 6%, split between a total of only 180 Trainers.
"Legendary" and "Common" holders earn 94%, split between the 5820 Trainers.
Most people won't get much just for holding one Trainer of any type, but in time,
it could be a good chunk of change each month. It's not unrealistic to expect 10%-20% of
the mint price per year if you're a Dragonborn holder.
...
they heard the Optimism community and support was warm and welcoming. Check out this exclusive
preview of a card design below that the Dragonia and Optimism teams constructed **together**!

![Optimism Card Art](https://optiland.s3.amazonaws.com/blog/final_card_op.png)

Plans to publicly reveal this card and a deep look into the gameplay (and more!) are being
released on-call with the Optimism Team on the next demo-day! With the super cool dragon art that this
project has, plenty of rewards for collecting and playing, and an active team that cares about their
community, Dragonia might be a project you don't want to miss out on.
